...
<head>
  <!-- Google Tag Manager -->
  <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-KTJTF9DT');</script>
...
<body class="${escapeHtml(className)}">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KTJTF9DT" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <section class="home-video-section" aria-label="Vídeos da Hirayama">
      ...
      <div class="home-video-list">
        ${videos.map((video, index) => `<article class="home-video-item">
          ...
          <a class="home-video-watch" href="https://youtube.com/shorts/${escapeHtml(video.id)}" target="_blank" rel="noopener">Assistir no YouTube <b aria-hidden="true">↗</b></a>
        </article>`).join('')}
      </div>
    </section>
...
.home-video-copy { position: relative; min-height: 76px; padding: 17px 34px 12px 0; }
...
.home-video-copy .cat { margin: 0; color: #f2bf61; font-size: 11px; }
.home-video-copy h3 {
  margin: 7px 0 0;
  color: white;
...
.home-video-watch:hover { color: #f2bf61; }
.post-card {
  min-height: 390px;
  display: flex;
  flex-direction: column;
...
@media (max-width: 560px) {
  ...
  .home-video-head h2 { font-size: 24px; }
  .home-video-list {
    grid-template-columns: 1fr;
    gap: 28px;
    max-width: 272px;
